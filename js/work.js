...
function togglenavbarBg() {
	...
	if(alpha) {
		...
		$('#bioFont').animate({ 'color': 'rgba(0, 0, 0, 1)' }, barAnimationDuration);
		...
		$('#bioFont').animate({ 'color': 'rgba(255, 255, 255, 1)' }, barAnimationDuration);
